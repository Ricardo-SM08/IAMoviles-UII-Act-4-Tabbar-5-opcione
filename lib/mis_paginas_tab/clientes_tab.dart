          ...
          children: [
            ...
            Container(
              ...
              child: ClipRRect(
                ...
                child: Image.network(
                  "https://raw.githubusercontent.com/Ricardo-SM08/imagenes-para-flutter-6-J-11-febrero-2026/refs/heads/main/cliente.png",
                  fit: BoxFit.cover,
                ),
              ),
            ),
            const SizedBox(height: 20),
            const Text(
              "Cientos de clientes satisfechos recorriendo las calles de Chihuahua.",
